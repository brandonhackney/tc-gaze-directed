...
A_centered = actual - mean(actual, 1, 'omitnan');
B_centered = predicted - mean(predicted, 1, 'omitnan');
% avoid a divide-by-zero error if your prediction is only an intercept
B_centered = B_centered + eps; 
